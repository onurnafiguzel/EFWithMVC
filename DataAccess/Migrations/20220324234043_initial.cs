    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Classrooms",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "B-245" });

            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "Id", "FirstName", "LastName", "SchoolId" },
                values: new object[] { 1, "Onur", "Güzel", "1" });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "FirstName", "LastName" },
                values: new object[] { 1, "Uğur", "Gürel" });

            migrationBuilder.InsertData(
                table: "Lessons",
                columns: new[] { "Id", "ClassroomId", "Name", "TeacherId" },
                values: new object[] { 1, 1, "Bitirme Projesi", 1 });

            migrationBuilder.InsertData(
                table: "StudentLessons",
                columns: new[] { "LessonId", "StudentId", "Id" },
